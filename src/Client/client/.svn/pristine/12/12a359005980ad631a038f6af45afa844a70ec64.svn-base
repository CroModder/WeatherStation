...
public class EditWeatherStationController {
	...
	public void initialize() throws SQLException {
    	...
    	if(LogInController.getUserAdmin().equals(1)){
    		...
    		paneAdminSlider.setDisable(false);
			freqSlider.setMin(1);
			...
			paneAdminSlider.setDisable(true);
		}
					...
					try {
						if(LogInController.getUserAdmin().equals(1)){
							...
							if(radioSeconds.isSelected()){
								...
								result = dbController.editWs(selctedWs, txtWsName.getText(), txtIPAdress.getText(),Integer.valueOf(txtPort.getText()), i);
							}
						}else{
							result = dbController.editWs(selctedWs, txtWsName.getText(), txtIPAdress.getText(),Integer.valueOf(txtPort.getText()), 1000);
						}
						} catch (Exception e) {
