...
public class RegisterController{
	...
	public void register(ActionEvent event) throws Exception{	
		...
		if (source instanceof Button) {
			...
			if(txtPassword2.getText().isEmpty() || txtRePassword.getText().isEmpty() || txtUserName2.getText().isEmpty() || txtEmail.getText().isEmpty()){
				...
				if (retVal.length() == 0) {
					String result[] = {""};
					try {
						result = dbController.register(txtUserName2.getText(),txtPassword2.getText(),txtEmail.getText());
					} catch (Exception e) {
					}
					if(result[0] == "true"){
